...
namespace Neural_Network
{
    public class NeuralNetwork
    {
        ...
        //Первые значения попадают в нейронную сеть
        ...
        private void FeedForwardAlLayersAfterInput()
        {
        ...
        public Neuron FeedForward(params double[] inputSignals)
        {
            ...
            {
                //Что возвращаем если выходное число нейронов больше 1
